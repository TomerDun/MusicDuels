    ...
    return (
        <div id="game-selector-container" className="p-8 pb-16 bg-gradient-to-br from-gray-900 to-black bg-black/70 border-1 border-white/2- rounded-md">
            ...
            <div id="game-buttons-container" className="flex flex-wrap justify-evenly">
                ...
                <div onClick={() => onPick('sight-read')} className="game-select-button interactive w-[30%] from-indigo-500/20 to-indigo-500/5">
                ...
                <div onClick={() => onPick('rythm-master')} className="game-select-button interactive w-[30%] from-yellow-400/20 to-yellow-400/10">
                ...
                <div onClick={() => onPick('perfect-ear')} className="game-select-button interactive w-[30%] from-teal-300/30 to-teal-200/10">
