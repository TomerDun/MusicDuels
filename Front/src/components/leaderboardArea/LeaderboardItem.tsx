    ...
    return (
        <div className="flex items-center justify-between gap-5 flex-1 outline-1 p-2 px-6 outline-indigo-500 hover:bg-white/10" id="leaderboard-item">
            ...
            <div id="stats-container" className="flex  justify-around gap-12 w-[50%] text-white/70">
                    <div className="font-bold text-white w-6">{item.stats.score}</div>
                    <div className="font-bold text-emerald-700 w-6">{item.stats.winRate}%</div>
                    <div className="font-bold text-white w-6">{item.stats.duels}</div>
                    <div className="font-bold text-yellow-300 w-6">{item.stats.streak}</div>
            </div>
